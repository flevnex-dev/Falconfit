                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">High light Home</th>
                            ...
                            @foreach($dataRow as $row)  
                                <tr>
                                    ...
                                    <td class="text-center">
                                      @if(!empty($row->image))
                                        <img class="img-thumbnail" src="{{asset('upload/category/'.$row->image)}}" style="height: 100px;">
                                      @endif
                                    </td>
                                    <td class="text-center">{{$row->high_light_home}}</td>
                                    <td class="text-center">{{$row->category_status}}</td>
